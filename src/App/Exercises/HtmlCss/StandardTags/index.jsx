...
export function Exercise() {
  ...
  <div class="faked-tags">
    ...
    <div className="birthday">
      ...
      25<span className="th" >th</span> birthday
    ...
    <div className="second-paragraph">
      ...
      happy birthday <span className="quote">quote</span> or wish that will surely make that

      special someone’s day a great day. Whether you’re celebrating your

      birthday or someone else’s, you can rely on our list of{' '}

      <span className="wishes">happy birthday</span> <span className="quote">quotes</span> to help put a smile on

      someone’s face. From inspirational to funny to cute sayings, browse

      our list of <span className="quote">quotes</span> to find one that resonates with you.{' '}
    ...
    <div className="use">
      ...
      Why not to use <span className="lists">lists</span> ?
    ...
    <div>
      ...
      <div className="h5">
        ...
        A lot of things to do <span className="todo">#todo</span>

      </div>

      <div className="todolist">

        <div className="todo1">Todo 1</div>

        <div className="todo1">Todo 2</div>

        <div className="todo1">Todo 3</div>
